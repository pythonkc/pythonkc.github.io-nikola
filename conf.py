...
BLOG_AUTHOR = "The PythonKC Organizer Team"  # (translatable)
BLOG_TITLE = "PythonKC"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pythonkc.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pythonkc.github.io/"
BLOG_EMAIL = "pythonkc@gmail.com"
BLOG_DESCRIPTION = "supporting the Python community in the greater Kansas City area"  # (translatable)
...
PAGES = (
    ("pages/*.markdown", "pages", "story.tmpl"),
